...
{
    public abstract class ResumificationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ResumificationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ResumificationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ResumificationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ResumificationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ResumificationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ResumificationDbContext, Task<T>> func)
        {
            T result;
